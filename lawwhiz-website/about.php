        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <h2 class="position-relative text-center bg-white text-primary rounded p-3 mt-4 mb-4 d-none d-lg-block" style="width: 350px; margin-left: -205px;">Your Legal Guidance Partner</h2>
                    <h6 class="text-uppercase">Learn About Us</h6>
                    <h1 class="mb-4">We Provide Reliable And Effective Legal Services</h1>
                    <p>Discover BLCS, your solution for reliable legal consultations. Our expert team of legal professionals is dedicated to simplifying complex legal matters for you. With personalized advice, accessible video consultations, and a commitment to your privacy, we empower you to make informed decisions. Get started today and navigate the legal landscape with confidence.</p>
