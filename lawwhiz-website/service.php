...
<head>
    <meta charset="utf-8">
    <title>BLCS -Legal Consultation Service </title>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <p>At BLCS, we are proud to offer a wide range of legal expertise to meet the diverse needs of our clients. Our team of experienced attorneys specializes in various practice areas, ensuring that you receive top-notch legal guidance and representation tailored to your specific situation.From resolving complex business matters to protecting your family's rights, we are here to navigate the legal landscape on your behalf. </p>
                ...
                <div class="col-lg-9 pt-5 pt-lg-0">
                    ...
                    <div class="owl-carousel service-carousel position-relative" style="margin-top: -100px; padding: 0 30px;">
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            ...
                            <p class="m-0">We represent clients in civil law cases, including disputes over property, contracts, and personal rights. Our team aims to find favorable resolutions through negotiation or litigation.</p>
                            <button><a href="lawyerscategory/civillawyers.php">See Lawyers</a></button>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <p class="m-0">We offer comprehensive family law services to help clients navigate divorce, child custody, spousal support, and other sensitive legal matters while protecting their rights and interests.</p>
                            <button><a href="lawyerscategory/familylawyer.php">See Lawyers</a></button>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <p class="m-0">Our business law practice provides legal guidance to startups and established companies, handling contract drafting, mergers and acquisitions, intellectual property, and regulatory compliance.</p>
                            <button><a href="lawyerscategory/businesslawhyer.php">See Lawyers</a></button>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <p class="m-0">Our experienced legal team specializes in criminal defense cases, providing expert representation for clients facing charges ranging from minor offenses to serious felonies.</p>
                            <button><a href="lawyerscategory/criminallawyer.php">See Lawyers</a></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid bg-secondary text-white pt-5 px-sm-3 px-md-5" style="margin-top: 90px;">
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-lg-center p-4" style="background: rgba(256, 256, 256, .05);">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="m-0">Independent University, Bangladesh</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 mt-n2 display-4 text-primary text-uppercase">BLCS</h1>
                </a>
        ...
        <div class="row p-4 mt-5 mx-0" style="background: rgba(256, 256, 256, .05);">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a class="font-weight-bold" href="#">BLCS</a>. All Rights Reserved.</p>
            </div>
